...
public class ThreadPoolConfigs {
    ...
    private final int DFT_POOL_SIZE = Runtime.getRuntime().availableProcessors() * 2;
    private final int DFT_MAX_POOL_SIZE = 64;
    private final int DFT_KEEP_ALIVE_TIME = Runtime.getRuntime().availableProcessors() * 2;
